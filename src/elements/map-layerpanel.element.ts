...
export class MapLayerpanelElement extends TailwindElement("") {
  ...
  protected render(): TemplateResult {
    return html`
      <div id="layerpicker-wrapper" class="z-10 absolute right-0 h-screen flex items-end">
        <button
            class="bottom-0 right-96 m-4 p-2 aspect-square w-16 bg-white hover:bg-zinc-100 z-10 text-vl-curious-blue text-center shadow">
        ...
        <div class="bg-zinc-100 h-screen w-[27rem] border-l">
          <h1 class="text-lg font-bold p-4 border-b bg-white">Layers</h1>
          <div class="p-4 border-b flex bg-white">
            <button
                class="text-sm bg-vl-curious-blue rounded py-2 px-4 text-center text-vl-white font-bold w-full mx-1">
              Add layer
            </button>
            <button
          ...
          <div class="p-4 border-b bg-white group">
            <div class="flex justify-between">
              ...
              <div class="flex-auto">
                <p class="line-clamp-2">Gebouwenregister: gebouweenheid (gepland) met meer tekst</p>
                <div class="mt-1 text-xs text-zinc-500">Zoom in to view this layer</div>
              </div>
              <ul class="hidden group-hover:flex">
                <li class="border-l h-full flex items-center px-2">
...
declare global {
  interface HTMLElementTagNameMap {
    "map-layerpanel": MapLayerpanelElement;
  }
}
